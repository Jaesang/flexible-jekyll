...
![OpenStack]({{ site.baseurl }}{{ post.url }}/images/openstack.png)
...
![OpeneStack-Helm]({{ site.baseurl }}{{ post.url }}/images/helm.png)
...
![Kubernetes]({{ site.baseurl }}{{ post.url }}/images/k8s-overview.png)
...
![openstack dashboard]({{ site.baseurl }}{{ post.url }}/images/openstack-dashboard.png)
...
Weave Scope는 설치된 TACO 노드의 30162 포트로 접속할 수 있습니다. Weave Scope UI를 통해서 Node, Pod, Container 정보와 서로간의 연결 현황을 확인할 수 있습니다. 브라우저에서 http://localhost:30162   또는  http://<테스트서버아이피>:30162로 접속할 수 있습니다.
 ...
 ![weavescope ui]({{ site.baseurl }}{{ post.url }}/images/Weavescope.png)
